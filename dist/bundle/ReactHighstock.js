...
module.exports = function (chartTypeExport, Highcharts) {
  ...
  var result = createReactClass({
    ...
    renderChart: function renderChart(config) {
      ...
      this.chart = new Highcharts[chartTypeExport](_extends({}, config, {
  ...
  result.withHighcharts = function (Highcharts, chartType) {
...
module.exports = __webpack_require__(11)('StockChart', __webpack_require__(26));
